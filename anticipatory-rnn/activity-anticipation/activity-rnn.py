...
def jointModel():
	...
	human_layers = [ConcatenateFeatures(inputHumanFeatures),
					LSTM('tanh', 'sigmoid', 'orthogonal', 4, 256), softmax(num_sub_activities)]
	object_layers = [ConcatenateFeatures(inputObjectFeatures),
					 LSTM('tanh', 'sigmoid', 'orthogonal', 4, 256), softmax(num_affordances)]
...
if __name__ == '__main__':
	...
	if not use_pretrained:
		...
		layers = [TemporalInputFeatures(inputD),
				  LSTM('tanh', 'sigmoid', 'orthogonal', 4, 512), softmax(num_classes)]
